...
export default function RootLayout({
  ...
  return (
    <main className="lap:h-screen tab:h-[200vh] mob:h-[300vh] bg-[#123] font-sans antialiased no-scrollbar scrollbar-hide select-none">
      <div className="flex lap:h-[52vh] -z-[1] bg-[url('/banner.jpg')] bg-top lap:bg-cover lap:pt-[3%] rounded-b-[20%] tab:bg-auto tab:pt-[4%] tab:h-[55vh] mob:bg-auto mob:h-[65vh] mob:pt-[5%]">
        <h2
          className={cn(
            freeman.className,
            "text-[32px] text-white h-auto lap:ml-[30%] tab:ml-12 mob:ml-8"
          )}
        >
          Hai, {memberName}
        </h2>
