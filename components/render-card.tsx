...
const CardFront = ({ imageUrl }: { imageUrl: string }) => (
  <div className="relative mx-auto bg-[url('/Sejatizen Card-front.png')] lap:w-[25vw] tab:w-[80vw] mob:w-[80vw] h-auto card-front">
    <Image
      ...
      width={1012}
      height={638}
      className="lap:w-[25vw] tab:w-[80vw] mob:w-[80vw] h-auto"
    />
  </div>
);
...
const CardBack = ({
  ...
  <div className="relative mx-auto bg-[url('/Sejatizen Card-back.png')] lap:w-[25vw] tab:w-[80vw] mob:w-[80vw] h-auto card-back">
    ...
    <div className="absolute w-[100%] my-auto mx-auto h-[5vh] box-content lap:top-[19%] tab:top-[23%] mob:top-[25%] grid grid-cols-2 gap-x-[6vw]">
      <div className="block lap:ml-[5vw] tab:ml-[9vw] mob:ml-[17vw]">
        <p
          className={cn(
            ...
            "lap:w-[10vw] tab:w-[17vw] mob:w-[30vw] text-white lap:text-[1.6vw] tab:text-[2.8vw] mob:text-[5vw] text-center font-normal"
          )}
        >
          {memberId}
        </p>
        <p
          className={cn(
            openSans.className,
            "lap:mt-[15%] tab:mt-[8%] mob:mt-[7%] lap:w-[10vw] tab:w-[17vw] mob:w-[30vw] text-black lap:text-[0.9vw] tab:text-[1.6vw] mob:text-[3vw] text-center font-semibold"
          )}
        >
          {name}
        </p>
        <p
          className={cn(
            openSans.className,
            "lap:mt-[25%] tab:mt-[18%] mob:mt-[18%] lap:w-[10vw] tab:w-[17vw] mob:w-[30vw] text-black lap:text-[0.9vw] tab:text-[1.6vw] mob:text-[3vw] text-center font-semibold"
          )}
        >
          {joinDate}
        </p>
      ...
      <QRCode
        className="relative lap:top-[23%] tab:top-[16%] mob:top-[20%] mx-auto lap:w-[10vw] tab:w-[10vw] mob:w-[4vw] h-auto"
        size={65}
        level="Q"
        fgColor="white"
        bgColor="transparent"
